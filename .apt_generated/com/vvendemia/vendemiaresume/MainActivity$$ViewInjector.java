...
public class MainActivity$$ViewInjector {
  public static void inject(Finder finder, final com.vvendemia.vendemiaresume.MainActivity target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131230723' for field 'thisIsMyName' was not found. If this field binding is optional add '@Optional'.");
    }
    target.thisIsMyName = (android.widget.TextView) view;
